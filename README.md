...
* reactphp/react - Event-driven, non-blocking I/O with PHP, formerly known as "Nuclear Reactor written in PHP"
...
* silexphp/Silex - The PHP micro-framework based on the Symfony Components
* top-think/think - PHP Framework ThinkPHP5——为API开发而设计的高性能PHP框架（基于PHP5.4+）
...
* wp-cli/wp-cli - The command line interface for WordPress
* Sylius/Sylius - eCommerce PHP framework built on top of Symfony with component-based architecture and format-agnostic rendering. (HTML/JSON/XML)
...
* invoiceninja/invoiceninja - Invoices, expenses & time-tracking built with Laravel
...
* pyrocms/pyrocms - Pyro is an experienced and powerful PHP CMS built lovingly for Laravel.
...
* PrestaShop/PrestaShop - PrestaShop offers a free, fully scalable, Open Source e-commerce solution.
...
PHPSocialNetwork/phpfastcache - The PHP high-performance object caching system ever. phpFastCache is a high-performance, distributed * object caching system, generic in nature, but intended for use in speeding up dynamic web applications by alleviating database load. phpFastCache dropped the database load to almost nothing, yielding faster page load times for users, better resource utilization. It is simple yet powerful
...
summerblue/phphub5 - PHPHub Ver 5 is a Forum project Powered by Laravel 5.1, and it is also the project build up PHP & Laravel China community
...
laracasts/PHP-Vars-To-Js-Transformer - Transform PHP types to JavaScript
...
cmgmyr/laravel-messenger - Simple user messaging package for Laravel (4 & 5)
...
unicodeveloper/laravel-hackathon-starter - 💻 :octocat: A hackathon/MVP boilerplate for laravel web applications. Start your hackathons without hassle.
...
TIGERB/easy-tips - A little Tips in my Code Career with PHP 🔥
...
JosephSilber/bouncer - Bouncer handles roles and abilities for Eloquent models
...
Payum/Payum - PHP 5.5+ Payment processing library. It offers everything you need to work with payments: Credit card & offsite purchasing, subscriptions, payouts etc.
...
endroid/QrCode - QR Code Generator incl. Symfony Bundle
...
LavaLite/cms - Lavalite - Multilingual PHP CMS built with Laravel and bootstrap
...
userfrosting/UserFrosting - A secure, modern PHP user management application and framework.
...
InvoicePlane/InvoicePlane - A free and open source invoicing application. Find out more at https://invoiceplane.com
...
MPOS/php-mpos - MPOS stands for Mining Portal Open Source. A unified mining interface for various Scrypt and SHA256d Crypto-currencies! Please be aware that the Issue tracker on Github is a Bug Tracker, not a Support Forum!
...
thephpleague/commonmark - Markdown parser for PHP based on the CommonMark spec.
...
irazasyed/telegram-bot-sdk - :robot: Telegram Bot API PHP SDK. Lets you build Telegram Bots easily! Supports Laravel out of the box.
...
php-school/cli-menu - :desktop_computer: Build beautiful PHP CLI menus. Simple yet Powerful. Expressive DSL.
...
craftcms/cms - A content-first CMS that aims to make life enjoyable for developers and content managers alike.
helei112g/payment - Payment是一个php版本的支付聚合第三方sdk，集成了微信支付、支付宝支付、招商一网通支付。提供统一的调用接口，方便快速接入各种支付、查询、退款、转账能力。
...
FriendsOfSymfony/FOSElasticaBundle - Elasticsearch PHP integration for your Symfony2 project using Elastica.
...
kahlan/kahlan - PHP Test Framework for Freedom, Truth, and Justice
...
jwage/purl - Purl is a simple Object Oriented URL manipulation library for PHP 5.3+
...
apiato/apiato - A flawless framework for building scalable and testable API-Centric Apps with PHP and Laravel.
...
lexik/LexikJWTAuthenticationBundle - This bundle provides JWT authentication for your Symfony REST API
...
barbushin/php-imap - Access mailbox by POP3/IMAP/NNTP using PHP IMAP extension
sendgrid/sendgrid-php - Official PHP Client Library for the SendGrid Web API
...
KnpLabs/KnpPaginatorBundle - SEO friendly Symfony2 paginator to sort and paginate
...
jublonet/codebird-php - Easy access to the Twitter REST API, Collections API, Streaming API, TON (Object Nest) API and Twitter Ads API — all from one PHP library.
jenssegers/optimus - :robot: Id obfuscation based on Knuth's multiplicative hashing method for PHP.
...
cytopia/devilbox - A modern dockerized LAMP and MEAN stack alternative to XAMPP
qieangel2013/zys - high performance service framework based on Yaf or Swoole
Hifone/Hifone - A free, open-source, self-hosted forum software based on the Laravel PHP Framework.
t0k4rt/phpqrcode - php QRcode generator library
peej/tonic - RESTful PHP library/framework
snc/SncRedisBundle - A Redis bundle for Symfony2 supporting Predis and PhpRedis
...
appzcoder/crud-generator - Laravel 5 CRUD Generator
...
webpatser/laravel-uuid - Laravel package to generate a UUID according to the RFC 4122 standard. Only support for version 1, 3, 4 and 5 UUID are built-in.
mauricesvay/php-facedetection - Detect face in images in pure PHP
ovr/phpsa - Smart/Static Analyzer(sis) for PHP :bowtie::neckbeard:
Microsoft/msphpsql - Microsoft PHP drivers for SQL Server
...
johnbillion/query-monitor - A WordPress plugin for monitoring database queries, hooks, conditionals, HTTP requests, query vars, environment, redirects, and more.
...
oroinc/crm-application - OroCRM Application
...
TheOrchid/Platform - CMS package for Laravel
...
KnpLabs/KnpSnappyBundle - Easily create PDF and images in Symfony2 by converting html using webkit
...
yupe/yupe - Yupe! is an open source Yiiframework-based online e-commerce solution
...
EnMarche/en-marche.fr - La plateforme citoyenne d'En Marche !
...
BenExile/Dropbox - PHP 5.3 SDK for the Dropbox REST API
...
spatie/browsershot - Convert a webpage to an image or pdf
...
Exeu/apai-io - Amazon Product Adverstising Library based on PHP REST and SOAP (only V1) using the Product Advertising API. Watch the Demo here: http://apaiio.dev.pixel-web.org/
...
contao/core - Contao Open Source CMS
movim/movim - Movim - Kickass Social Network
...
sensiolabs/security-checker - PHP frontend for security.sensiolabs.org
...
api-platform/core - The Hypermedia REST API component of API Platform: JSON-LD and Hydra support, works with Symfony too
...
pusher/pusher-http-php - PHP library for interacting with the Pusher HTTP API | owner=@luismfonseca
...
FriendsOfPHP/uprofiler - Lightweight profiler for PHP (based on facebook/xhprof)
...
alextselegidis/easyappointments - Easy!Appointments - Open Source Web Scheduler
...
symfony/console - [READ-ONLY] Subtree split of the Symfony Console Component
...
1up-lab/OneupUploaderBundle - This Symfony2 bundle provides a server implementation for handling single and multiple file uploads using either FineUploader, jQuery File Uploader, YUI3 Uploader, Uploadify, FancyUpload, MooUpload, Plupload or Dropzone. Features include chunked uploads, orphanages, Gaufrette and Flysystem support.
...
firefly-iii/firefly-iii - Firefly: a personal finances manager
...
laravolt/avatar - Plug n play avatar, turn name, email, and any other string into beautiful avatar, effortless.
...
miniflux/picoFeed - PHP library to parse and write RSS/Atom feeds
...
JayBizzle/Crawler-Detect - :spider: CrawlerDetect is a PHP class for detecting bots/crawlers/spiders via the user agent
...
symfony/dom-crawler - [READ-ONLY] Subtree split of the Symfony DomCrawler Component
...
php-enqueue/enqueue-dev - Message queue packages for PHP, Symfony, Magento exts. RabbitMQ, Amazon SQS, Redis, Service bus, Async events, RPC over MQ and a lot more
...
luyadev/luya - The Yii 2 wrapper to build beautiful and easy editable websites pretty fast!
...
amphp/artax - An async HTTP/1.1 client for Amp.
...
jrean/laravel-user-verification - PHP package built for Laravel 5.* to easily handle a user verification and validate the e-mail
...
eventviva/php-image-resize - PHP library to resize, scale and crop images
...
Cacti/cacti - Cacti ™
thorsten/phpMyFAQ - phpMyFAQ - Open Source FAQ system for PHP and HHVM with MySQL, PostgreSQL and other databases
...
jitamin/jitamin - Jitamin is a free software written in PHP, intended to handle the project management over the web.
...
GitaminHQ/Gitamin - An open-source, self-hosted git repository management software based on the Laravel PHP Framework.
symfony/http-foundation - [READ-ONLY] Subtree split of the Symfony HttpFoundation Component
shadowhand/latitude - A SQL query builder for PHP with zero dependencies
...
postaddictme/instagram-php-scraper - Instagram PHP Scraper. Get account information, photos, videos and comments without any authorization
...
pascaldevink/shortuuid - PHP 5.6+ library that generates concise, unambiguous, URL-safe UUIDs
...
felixfbecker/php-language-server - PHP Implementation of the VS Code Language Server Protocol 🆚↔:desktop_computer:
...
caoym/phpboot - A lightweight and powerful PHP RESTful framework. ✨ 快速开发RESTful接口的框架✨
...
fguillot/JsonRPC - Simple Json-RPC PHP client/server that just works.
...
fguillot/picoFeed - PHP library to parse and write RSS/Atom feeds
...
Roave/StrictPhp - 🚫 ✨ ❗️ AOP-based strict type checks for PHP
...
bugsnag/bugsnag-laravel - Bugsnag notifier for the Laravel PHP framework
alexbilbie/Proton - A micro PHP framework
...
alexbilbie/MongoQB - A PHP MongoDB query builder library
...
zendframework/zend-expressive - Start to develop PSR-7 middleware applications in PHP in a minute!
...
kamranahmedse/php-geocode - A wrapper around Google's Geocoding API to get different details such as latitude, longitude, country, city, district, postcode, town and street number regarding some specific address.
...
ryancramerdesign/ProcessWire - ProcessWire 2.7. PHP 5 based CMS and CMF (content management system and framework). See the dev branch for the latest development version (new versions weekly).
...
akanehara/ginq - LINQ to Object inspired DSL for PHP
stripe/wilde-things - A tutorial integrating Stripe in PHP
